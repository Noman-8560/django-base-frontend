# Generated by Django 3.2.9 on 2021-11-14 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(blank=True, related_name='_application_team_participants_+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='application.screen'),
        ),
        migrations.CreateModel(
            name='QuizCompleted',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen_2', models.BooleanField(default=False)),
                ('screen_3', models.BooleanField(default=False)),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.questionimage')),
                ('quiz_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.quizquestion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen_2', models.BooleanField(default=False)),
                ('screen_3', models.BooleanField(default=False)),
                ('audio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.questionaudio')),
                ('quiz_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.quizquestion')),
            ],
            options={
