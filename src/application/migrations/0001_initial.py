    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(blank=True, related_name='_quiz_questions_+', to='src.application.Question')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='participating-in+', to='src.application.quiz')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('guardian', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='guardian+', to='src.application.guardian')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='src.application.quiz')),
        ...
        migrations.AddField(
            model_name='quiz',
            name='subjects',
            field=models.ManyToManyField(blank=True, to='src.application.Subject'),
        ),
        migrations.AddField(
            model_name='quiz',
            name='submission_control',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.application.screen'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='src.application.screen')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.application.question')),
                ('screen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.application.screen')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='select_choices', to='src.application.screen'),
        ),
        migrations.AddField(
            model_name='question',
            name='quiz',
            field=models.ManyToManyField(blank=True, related_name='quiz', to='src.application.Quiz'),
        ),
        migrations.AddField(
            model_name='question',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.application.subject'),
        ),
        migrations.AddField(
            model_name='question',
            name='submission_control',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submitted_by', to='src.application.screen'),
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='question-attempt+', to='src.application.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='question-attempt+', to='src.application.question')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.application.quiz')),
                ('team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='src.application.team')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempt-by+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
