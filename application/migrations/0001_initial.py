# Generated by Django 3.0.2 on 2020-11-08 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('image_hint_url', models.URLField(blank=True, max_length=500, null=True)),
                ('audio_hint_url', models.URLField(blank=True, max_length=500, null=True)),
                ('image_hint_file', models.FileField(blank=True, null=True, upload_to='static/Uploads/')),
                ('audio_hint_file', models.FileField(blank=True, null=True, upload_to='static/Uploads/')),
                ('modified_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.Option')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.Question')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='question',
            name='options',
            field=models.ManyToManyField(related_name='_question_options_+', through='application.QuestionOption', to='application.Option'),
        ),
        migrations.AddField(
            model_name='question',
            name='quiz',
